...
describe('RUT verifier', () => {
  it('invalid string returns error', done => {
    rut.verify('sdfwer')
      ...
      .catch(e => {
        expect(e.message)
          .to.equal('Input contains invalid characters')
        done();
      })
      .catch(e => done(e))
  })
